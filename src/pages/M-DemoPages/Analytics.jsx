...
const Analytics = () => {
  ...
  console.log(orders.map(order => order.totalFoodPrice))


    const [analytics, setAnalytics] = useState({
        totalRevenue: orders.reduce((sum, order) => sum + (order.totalFoodPrice || 0), 0),
        orderCount: 1547,
        customerCount: 892,
        revenueGrowth: 12.5,
        orderGrowth: 8.3,
...
//     const totalRevenue = orders.reduce((sum, order) => sum + (order.totalFoodPrice || 0), 0);
